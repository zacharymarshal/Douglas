...
class ReportTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		$report = new \Douglas\Request\Report(array(
	...
	public function testGetUrl()
	{
		...
		$this->assertEquals('/rest_v2/reports/organizations/demo/Reports/TestReport.html?test_param=test_value', $report->getUrl());
	}
