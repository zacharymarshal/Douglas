...
class RequestTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		self::$successful_request = new \Douglas\Request(array(
			'jasper_url' => getJasperUrl(),
			'url'        => '/rest_v2/reports/organizations/dna_demo3/Reports/Test/Bad_Parameter.html',
		));
		self::$failed_request = new \Douglas\Request(array(
			'jasper_url' => getJasperUrl(),
			'url'        => '/rest_v2/reports/organizations/dna_demo3/Reports/Test/Bad_Parameter.html?academic_year=',
		));
	}
	...
	{
		$first_request = new \Douglas\Request(array(
			'jasper_url' => getJasperUrl(),
			'url'        => '/rest_v2/reports/organizations/dna_demo3/Reports/Test/Bad_Parameter.html',
		));
		$first_request->send();
